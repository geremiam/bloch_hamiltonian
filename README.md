Module contains a class (magnonsystem_t) for computing the Bloch Hamiltonian of translation-invariant linear spin-wave systems. See the docstrings in the class and method definitions.
